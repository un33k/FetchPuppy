...
# JobSite Bootstrap Script
# Sets up Python via pyenv (if needed) and creates virtual environment with job scraping and AI analysis tools
...
# Install JobSite dependencies
install_deps() {
    log "Activating virtual environment and installing job scraping and AI analysis tools..."
    
    source "$VENV_DIR/bin/activate"
    pip install --upgrade pip
    
    # Install job scraping and AI analysis tools
    pip install \
        "requests>=2.31.0" \
...
# Main execution
main() {
    echo -e "${BLUE}🚀 JobSite Bootstrap${NC}"
    echo "Setting up Python development environment for job scraping and AI analysis..."
    echo
    ...
    echo "  2. Run the job scraper to collect job data"
    echo "  3. Use the AI analysis tools to match jobs to your resume"
    echo
